package com.fari.fx_calculator;
...
public class Calc extends Application {
    ...
    private VBox createLayout(TextField screen, TilePane buttons) {
        ...
        layout.setStyle("-fx-background-color: #1eaed2; -fx-padding: 20; -fx-font-size: 20;");
    ...
    private TextField createScreen() {
        ...
        screen.setStyle("-fx-background-color: #b2b3d5;");
